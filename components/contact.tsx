...
export function Contact() {
  return (
    <section id="contato" className="py-24 px-6 border-t border-white/[0.06]">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-[#A0A0A0] leading-relaxed mb-10">
            Tem uma ideia de produto, quer uma parceria ou só quer trocar uma
            ideia sobre microsaas e IA? Me chama.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a
              ...
              className="flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-xl bg-gradient-to-r from-[#00C4BE] to-[#00E5D0] text-[#080808] font-semibold text-sm hover:opacity-90 active:scale-95 transition-all"
            >
              <WhatsAppIcon />
              WhatsApp
            </a>
